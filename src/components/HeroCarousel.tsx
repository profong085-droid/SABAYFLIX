        ...
        <div className="relative flex items-center justify-center w-full max-w-[360px] md:max-w-[600px] lg:max-w-[900px]">
          {movies.map((movie, index) => {
            ...
            if (isActive) {
              ...
              transformClass = "scale-[0.85] opacity-40 z-10 -translate-x-[90%] blur-[0.5px]";
            } else if (isNext) {
              transformClass = "scale-[0.85] opacity-40 z-10 translate-x-[90%] blur-[0.5px]";
            }
            ...
            return (
              ...
              >
                <div className="relative w-[155px] h-[230px] md:w-[240px] md:h-[360px] lg:w-[300px] lg:h-[450px] rounded-[20px] overflow-hidden shadow-2xl border border-gray-800">
                  <Image
                    src={movie.poster}
                    alt={movie.title}
                    fill
